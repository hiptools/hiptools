...
#                        ('%>', u'\2')]
        ...
        self.b_ucs_lst = [                        
                        ...
                        (u'JА3', u'\u004b'), 
                        (u'JА1', u'\u042f\u007e'), 
                        (u'JА', u'J\u0410'), # приведение к универсальному
...
#                        u('jа', u'\u044f'),
                        ...
                        #u маскируем дифтонги, сочетания с i
#                        u('о_у4', u'\u045c'),              # о_у
#                        u('о_у3', u'\u045e'),              # о_у
                        (u'о<у>', u'о_у'),              # о_у
                        (u'о_у', u'\u0075'),              # о_у
...
#                        u('_е', u''), 
                        ...
                        (u'я5', u'\u007c'),          # юс малый 
#                        u('я1', u'\u0073'),    # показывает s вместо юникода. PyGTK?
...
#                        u# basic conversion                        
                        (u's', u'\u0455'),
                        (u'kk', u'\u0073'),   #  подстановка для я1 
                        (u"jь1", u'\u0451'),    # ять
                        (u'jь2', u'\u0401'),
                        (u'jь6', u'\u044d^'),
                        (u'jь', u'\u044d'),
                        (u"у1", u'\u0079'),    # у лигатурное с ударением
                        (u"у2", u'\u0059'),
                        (u"у6", u'\u007b'),     
                        (u'<е>', u'\u0454'),   # вытянутое е
                        (u'_w', u'\u045a'),
                        ...
                        (u'r1', u'j'),
                        (u'r2', u'J'),
                        (u'i', u'\u0456'),          # i с двумя точками (default)
                        (u'u3', u'\u045e'),         # о_у=
                        (u'u4', u'\u045c'),         # о_у='
                        (u'jа', u'\u044f'),
                        (u'@', u'\u00b0')]
